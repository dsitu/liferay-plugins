...
/**
 * The base model implementation for the Type service. Represents a row in the &quot;SAMVC_Type&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class TypeModelImpl extends BaseModelImpl<Type> implements TypeModel {
	 ...
	 */
	public static final String TABLE_NAME = "SAMVC_Type";
	...
	public static final String TABLE_SQL_CREATE = "create table SAMVC_Type (typeId LONG not null primary key,groupId LONG,name VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table SAMVC_Type";
	public static final String ORDER_BY_JPQL = " ORDER BY type.name ASC";
	public static final String ORDER_BY_SQL = " ORDER BY SAMVC_Type.name ASC";
